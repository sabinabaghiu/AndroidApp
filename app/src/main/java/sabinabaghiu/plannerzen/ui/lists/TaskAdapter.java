...
public class TaskAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void editItem(int position){
        Task section = sections.get(position).getTask();
        EditTaskViewModel.getInstance().editTask(section);
        Navigation.findNavController((Activity) context, R.id.nav_host_fragment).navigate(R.id.navigation_edit_task);
